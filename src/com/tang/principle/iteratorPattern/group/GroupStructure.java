...
import com.tang.principle.iteratorPattern.group.lang.Collection;
...
/**
 * ClassName:G Package:com.tang.principle.iteratorPattern.group @Date:2021/10/27 20:45 @Author:TYH
 */
public class GroupStructure implements Collection<Employee, Link> {
    ...
    private Map<String, List<Link>> linkMap =
            new ConcurrentHashMap<String, List<Link>>(); // 组织架构关系；id->list
